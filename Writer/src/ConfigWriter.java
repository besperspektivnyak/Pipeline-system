...
public class ConfigWriter {
    ...
    public ConfigWriter(Logger logger) { LOGGER = logger; }
        ...
        try {
            ...
            while ((tmp = inputStr.readLine()) != null) {
                ...
                if (paramTmp[0].equals(grammar.GrammarToken(0))) {
                    ...
                    LOGGER.log(Level.INFO, "Parse writer config was successful");
                }
                else {
            ...
            LOGGER.log(Level.SEVERE, "Can not open or read writer's config");
